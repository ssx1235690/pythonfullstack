    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='leleyao.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('authors', models.ManyToManyField(to='leleyao.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
        ...
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leleyao.Publisher'),
        ),
    ]
